...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        Category::factory()->create([
            'image' => 'https://images.unsplash.com/photo-1560448205-97abe7378152?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80',
            'name' => 'Furniture'
        ]);

        Category::factory()->create([
            'image' => 'https://images.unsplash.com/photo-1526738549149-8e07eca6c147?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1325&q=80',
            'name' => 'Electronics'
        ]);
