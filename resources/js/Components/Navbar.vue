        ...
        <div class="container mx-auto px-6 py-3">
            ...
            <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                <div class="flex flex-col sm:flex-row">
                    <Link class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" :href="route('index')">
                        Home
                    </Link>
                    <Link class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" :href="route('products.index')">
                        View Products
                    </Link>
                    <Link v-if="!$page.props.user" class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" :href="route('login')">
                        Sign in/Sign Up
                    </Link>

                    <!-- Protected routes -->
                    <Link v-if="$page.props.user" class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" :href="route('products.create')">
                        Create
                    </Link>
                    <Link v-if="$page.props.user" class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" :href="route('profile.show')">
                        My Profile
                    </Link>
                </div>
            </nav>
